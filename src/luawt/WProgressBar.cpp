...
int luawt_WProgressBar_setValueStyleClass(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WProgressBar.setValueStyleClass: %d", argc);
    }
}
...
int luawt_WProgressBar_setState(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WProgressBar.setState: %d", argc);
    }
}
