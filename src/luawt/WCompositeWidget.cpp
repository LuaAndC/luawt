...
int luawt_WCompositeWidget_setDeferredToolTip(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WCompositeWidget.setDeferredToolTip: %d", argc);
    }
}
...
int luawt_WCompositeWidget_objectName(lua_State* L) {
    int argc = lua_gettop(L) - 1;

    WCompositeWidget* self = luawt_checkFromLua<WCompositeWidget>(L, 1);
        if (argc == 0) {
    std::string result = self->objectName();
    lua_pushstring(L, result.c_str());
    return 1;

    } else {
        return luaL_error(L, "Wrong arguments number for WCompositeWidget.objectName: %d", argc);
    }
}
...
int luawt_WCompositeWidget_zIndex(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WCompositeWidget.zIndex: %d", argc);
    }
}
...
int luawt_WCompositeWidget_hasStyleClass(lua_State* L) {
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WCompositeWidget.hasStyleClass: %d", argc);
    }
}

int luawt_WCompositeWidget_setObjectName(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WCompositeWidget.setObjectName: %d", argc);
    }
}
...
static const luaL_Reg luawt_WCompositeWidget_methods[] = {
    METHOD(WCompositeWidget, setObjectName),
    METHOD(WCompositeWidget, objectName),
    ...
    METHOD(WCompositeWidget, setDeferredToolTip),
    ...
    METHOD(WCompositeWidget, zIndex),
