...
int luawt_WSlider_valueText(lua_State* L) {
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WSlider.valueText: %d", argc);
    }
}
...
int luawt_WSlider_setDisabled(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WSlider.setDisabled: %d", argc);
    }
}
...
int luawt_WSlider_setHandleWidth(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WSlider.setHandleWidth: %d", argc);
    }
}
...
int luawt_WSlider_setValueText(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WSlider.setValueText: %d", argc);
    }
}
...
int luawt_WSlider_handleWidth(lua_State* L) {
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WSlider.handleWidth: %d", argc);
    }
}
