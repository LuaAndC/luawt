...
int luawt_WInPlaceEdit_make(lua_State* L) {
    ...
    WInPlaceEdit * result = new WInPlaceEdit(parent);
...
int luawt_WInPlaceEdit_setPlaceholderText(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WInPlaceEdit.setPlaceholderText: %d", argc);
    }
}
...
int luawt_WInPlaceEdit_placeholderText(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WInPlaceEdit.placeholderText: %d", argc);
    }
}
...
static const luaL_Reg luawt_WInPlaceEdit_methods[] = {
    ...
    METHOD(WInPlaceEdit, setPlaceholderText),
    METHOD(WInPlaceEdit, placeholderText),
