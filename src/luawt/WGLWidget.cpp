...
int luawt_WGLWidget_initializeGL(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.initializeGL: %d", argc);
    }
}
...
int luawt_WGLWidget_paintGL(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.paintGL: %d", argc);
    }
}
...
int luawt_WGLWidget_injectJS(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.injectJS: %d", argc);
    }
}
...
int luawt_WGLWidget_enableClientErrorChecks(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.enableClientErrorChecks: %d", argc);
    }
}
...
int luawt_WGLWidget_renderbufferStorage(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.renderbufferStorage: %d", argc);
    }
}
...
int luawt_WGLWidget_clearBinaryResources(lua_State* L) {
    int argc = lua_gettop(L) - 1;

    WGLWidget* self = luawt_checkFromLua<WGLWidget>(L, 1);
        if (argc == 0) {
    self->clearBinaryResources();
    return 0;
    
    } else {
        return luaL_error(L, "Wrong arguments number for WGLWidget.clearBinaryResources: %d", argc);
    }
}
...
int luawt_WGLWidget_webglNotAvailable(lua_State* L) {
    int argc = lua_gettop(L) - 1;

    WGLWidget* self = luawt_checkFromLua<WGLWidget>(L, 1);
        if (argc == 0) {
    self->webglNotAvailable();
    return 0;
    
    } else {
        return luaL_error(L, "Wrong arguments number for WGLWidget.webglNotAvailable: %d", argc);
    }
}

int luawt_WGLWidget_resizeGL(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.resizeGL: %d", argc);
    }
}
...
int luawt_WGLWidget_bufferData(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.bufferData: %d", argc);
    }
}

int luawt_WGLWidget_updateGL(lua_State* L) {
    int argc = lua_gettop(L) - 1;
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WGLWidget.updateGL: %d", argc);
    }
}
...
static const luaL_Reg luawt_WGLWidget_methods[] = {
    METHOD(WGLWidget, initializeGL),
    METHOD(WGLWidget, resizeGL),
    METHOD(WGLWidget, paintGL),
    METHOD(WGLWidget, updateGL),
    ...
    METHOD(WGLWidget, clearBinaryResources),
    ...
    METHOD(WGLWidget, webglNotAvailable),
