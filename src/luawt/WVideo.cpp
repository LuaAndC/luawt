...
int luawt_WVideo_make(lua_State* L) {
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WVideo.make: %d", argc);
    }
}
...
int luawt_WVideo_jsVideoRef(lua_State* L) {
    ...
    return 1;
        ...
        return luaL_error(L, "Wrong arguments number for WVideo.jsVideoRef: %d", argc);
    }
}
...
int luawt_WVideo_setPoster(lua_State* L) {
    ...
    return 0;
        ...
        return luaL_error(L, "Wrong arguments number for WVideo.setPoster: %d", argc);
    }
}
